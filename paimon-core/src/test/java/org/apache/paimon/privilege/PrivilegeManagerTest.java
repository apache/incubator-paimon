...
/** Tests for {@link PrivilegeManager}. */
public class PrivilegeManagerTest {
    ...
    public void testUsers() throws Exception {
        ...
        PrivilegeManager rootManager = getPrivilegeManager("root", PASSWORD_ROOT);
        rootManager.createUser("test", "passwd");
        assertThrows(
                IllegalArgumentException.class, () -> rootManager.createUser("test", "changed"));

        PrivilegeManager testManager = getPrivilegeManager("test", "passwd");
    ...
    private PrivilegeManager getPrivilegeManager(String user, String password) throws Exception {
